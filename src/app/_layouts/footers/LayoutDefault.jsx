...
const DefaultFooter = () => {
  ...
  return (
    ...
    <footer className="mil-relative">
        <img src="/img/footer.jpg" className="mil-bg-img mil-parallax" alt="image" style={{"objectPosition": "top"}} data-value-1="-25%" data-value-2="23%" />
            ...
            <div className="row align-items-end">
                <div className="col-lg-8">
                    <div className="row">
                        ...
                        <div className="col-md-6 col-lg-6 col-xl-3">
                            <span className="mil-suptitle mil-light mil-upper mil-up mil-mb-30">ADRESS</span>
                            <p className="mil-text-sm mil-up mil-light-soft mil-mb-30">8619 S Wolcott Avenue Floor 202 <br/>Chicago, IL 60620 <br/>(773) 238 - 7162</p>
                        </div>
                        {/* <div className="col-md-6 col-lg-6 col-xl-3">
                ...
                <div className="col-lg-4">
                    <Link href="/" className="mil-footer-logo mil-up mil-mb-30">
                        <img src="/img/logo/logo.svg" alt={AppData.footer.logo.alt} style={{"width": "130px"}} />
                    </Link>
                </div>
            </div>
        </div>
